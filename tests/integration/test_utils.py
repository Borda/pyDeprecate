...
class TestWarningCall:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param((UserWarning,), {}, r"While catching `UserWarning` warnings, these were found:", raise_pow, id="UserWarning"),
            pytest.param(
                (UserWarning,),
                {"match": "you!"},
            ...
            pytest.param((FutureWarning,), {}, r"While catching `FutureWarning` warnings, these were found:", raise_pow_future, id="FutureWarning"),
        ],
    )
    def test_warning_raised(self, ctx_args: tuple, ctx_kwargs: dict, expected_msg: str, call_fn: Callable[..., float]) -> None:
