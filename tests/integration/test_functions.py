...
class TestDeprecationWarnings:
    ...
    def test_function_to_class_forwarding(self) -> None:
        ...
        depr_make_new_cls._state.warned_calls = 0
        with pytest.warns(
            FutureWarning,
    ...
    def test_function_to_class_forwarding_with_args_mapping(self) -> None:
        ...
        depr_make_new_cls_mapped._state.warned_calls = 0
        with pytest.warns(
            FutureWarning,
...
class TestArgumentMapping:
    ...
    def test_arguments_double_mixed(self) -> None:
        ...
        depr_pow_self_double._state.warned_args.clear()
...
class TestErrorHandling:
    ...
    def test_incomplete_once(self) -> None:
        ...
        depr_pow_args._state.warned_calls = 0
        with pytest.warns(FutureWarning):
            depr_pow_args(2, 1)
        with assert_no_warnings(FutureWarning):
...
class TestDeprecatedFunctionWrappers:
    ...
    def reset_warnings(self) -> None:
        ...
        depr_timing_wrapper._state.warned_calls = 0
...
class TestDeprecatedClassWrappers:
    ...
    def reset_warnings(self) -> None:
        ...
        DeprecatedTimerDecorator.__init__._state.warned_calls = 0
