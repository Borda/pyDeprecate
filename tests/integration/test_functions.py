...
class TestDeprecationWarnings:
    ...
    def test_function_to_class_forwarding(self) -> None:
        ...
        depr_make_new_cls._state.warned_calls = 0  # type: ignore[attr-defined]
        with pytest.warns(
            FutureWarning,
    ...
    def test_function_to_class_forwarding_with_args_mapping(self) -> None:
        ...
        depr_make_new_cls_mapped._state.warned_calls = 0  # type: ignore[attr-defined]
        with pytest.warns(
            FutureWarning,
    ...
    def test_default_once(self, func: Callable) -> None:
        ...
        func._state.warned_calls = 0  # type: ignore[attr-defined]
...
class TestArgumentMapping:
    ...
    def _reset_deprecation_state(self) -> None:
        ...
        for func in (decorated_pow_self, depr_pow_self_double, depr_pow_self_twice, wrapped_pow_self):
            state = func._state  # type: ignore[attr-defined]
    ...
    def test_arguments_double_mixed(self) -> None:
        ...
        depr_pow_self_double._state.warned_args.clear()  # type: ignore[attr-defined]
...
class TestErrorHandling:
    ...
    def test_incomplete_once(self) -> None:
        ...
        depr_pow_args._state.warned_calls = 0  # type: ignore[attr-defined]
        with pytest.warns(FutureWarning):
            depr_pow_args(2, 1)
        with assert_no_warnings(FutureWarning):
...
class TestDeprecatedFunctionWrappers:
    ...
    def reset_warnings(self) -> None:
        ...
        depr_timing_wrapper._state.warned_calls = 0  # type: ignore[attr-defined]
...
class TestDeprecatedClassWrappers:
    ...
    def reset_warnings(self) -> None:
        ...
        DeprecatedTimerDecorator.__init__._state.warned_calls = 0  # type: ignore[attr-defined]
