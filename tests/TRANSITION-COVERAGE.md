...
| `make_class_target_none_with_args_mapping`  | `target=None`           | `target=None` normalised to NOTIFY; `args_mapping` auto-resolves to ARGS_REMAP (option C — no longer stripped) |
