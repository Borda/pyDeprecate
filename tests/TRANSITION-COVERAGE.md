...
| `make_class_target_none_with_args_mapping`  | `target=None`           | legacy `target=None` forwarded as an unset target; `args_mapping` auto-resolves to ARGS_REMAP and is applied |
