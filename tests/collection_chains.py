...
@deprecated(target=TargetMode.ARGS_REMAP, deprecated_in="1.2", remove_in="2.0", args_mapping={"c1": "nc2"})
@deprecated(target=TargetMode.ARGS_REMAP, deprecated_in="1.2", remove_in="2.0", args_mapping={"nc1": "nc2"})
