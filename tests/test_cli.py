...
def test_cli_found_issues(mock_find: MagicMock) -> None:
    ...
    info = DeprecatedCallableInfo(module="test_mod", function="test_func", invalid_args=["bad_arg"])
...
def test_cli_found_warnings_only(mock_find: MagicMock) -> None:
    ...
    info = DeprecatedCallableInfo(module="test_mod", function="test_func", identity_mapping=["arg"], no_effect=True)
