...
│   ├── integration/                # Integration tests (public API end-to-end)
...
│   │   └── test_readme.py              # README examples (generated by phmdoctest)
│   └── unittests/              # Unit tests for private/internal helpers
│       ├── test_utils.py           # Tests for deprecate.utils internals
│       ├── test_audit.py           # Tests for deprecate.audit internals
│       └── test_deprecation.py     # Tests for deprecate.deprecation internals
├── .github/
...
| `integration/test_*.py`       | Integration tests — exercise the public API end-to-end via the collection modules         |
| `unittests/test_*.py`         | Unit tests — directly import and test private/internal helpers in isolation               |
