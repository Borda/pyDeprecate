...
- Consult the [agent guide](https://borda.github.io/pyDeprecate/llms.txt) for the relevant pattern, then verify it against installed signatures/source or matching release docs. The root guide may describe a newer release.
